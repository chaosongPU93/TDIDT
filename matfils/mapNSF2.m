...
for k=1:ntees
    ...
    %hold on
    if k==1
        axes('position',[0.05 0.62 0.35 0.35],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
    elseif k==2
        axes('position',[0.35 0.62 0.35 0.35],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
        %position
    elseif k==3
...
% %     hold on
    if k==1
        k
        axes('position',[0.05 0.08 0.21 0.21],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
%     elseif k==2
...
%     hold on
    if k==1
        subplot('position',[0.26 0.08 0.21 0.21],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
    elseif k==2
        subplot('position',[0.47 0.08 0.21 0.21],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
%     elseif k==3
