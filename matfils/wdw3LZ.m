...
set(0,'DefaultFigureVisible','on');
    ...
    timoffrot(1,:)=[2005 254 07 42 12 -010 -030  25  55  45];
    timoffrot(2,:)=[2005 255 07 42 12 -010 -030  25  55  45];
    timoffrot(3,:)=[2004 196 07 42 12 -010 -030  25  55  45];
    timoffrot(4,:)=[2004 197 07 42 12 -010 -030  25  55  45];
    timoffrot(5,:)=[2003 062 07 42 12 -010 -030  25 235  45];  %TW flipped in 2003
    timoffrot(6,:)=[2003 063 07 42 12 -010 -030  25 235  45];  %TW flipped in 2003
...
ArmCat=load(['/data2/arubin/CNDC/',YEAR,'/list.',YEAR,'.lztwmgMAJ']);
...
npo=2;
npa=1;
[PGCEf]=2.4e-3*bandpass(PGCE,40,lo,hi,npo,npa,'butter');
[PGCNf]=2.4e-3*bandpass(PGCN,40,lo,hi,npo,npa,'butter');
...
orient landscape
print('-depsc',['LZTWMG/FIGS/',IDENTIF,'-ms',int2str(mshift),'-',int2str(winlen/40),'s_',int2str(lo),'-',int2str(hi),'a.eps'])
...
fid = fopen(['LZTWMG/map',IDENTIF,'_',int2str(lo),'-',int2str(hi),'-','ms',int2str(mshift),'-',int2str(winlen/40),'s'],'w');
...
title([IDENTIF,'_{',int2str(lo),'-',int2str(hi),'}'])
orient landscape
print('-depsc',['LZTWMG/FIGS/',IDENTIF,'-ms',int2str(mshift),'-',int2str(winlen/40),'s_',int2str(lo),'-',int2str(hi),'b.eps'])
...
title([IDENTIF,'_{',int2str(lo),'-',int2str(hi),'}'])
orient landscape
print('-depsc',['LZTWMG/FIGS/',IDENTIF,'-ms',int2str(mshift),'-',int2str(winlen/40),'s_',int2str(lo),'-',int2str(hi),'c.eps'])
...
title([IDENTIF,'_{',int2str(lo),'-',int2str(hi),'}'])
orient landscape
print('-depsc',['LZTWMG/FIGS/',IDENTIF,'-ms',int2str(mshift),'-',int2str(winlen/40),'s_',int2str(lo),'-',int2str(hi),'d.eps'])
...
box on
title([IDENTIF,'_{',int2str(lo),'-',int2str(hi),'}'])
print('-depsc',['LZTWMG/FIGS/',IDENTIF,'-ms',int2str(mshift),'-',int2str(winlen/40),'s_',int2str(lo),'-',int2str(hi),'e.eps'])
...
%                     plot(pks(:,1),pks(:,2),'r+')
    ...
    orient landscape
    if ifig <= 9
        print('-depsc',['LZTWMG/WIGS/',IDENTIF,'-',int2str(lo),'-',int2str(hi),'.',int2str(0),int2str(0),int2str(ifig),'.eps'])
    elseif ifig <= 99
        print('-depsc',['LZTWMG/WIGS/',IDENTIF,'-',int2str(lo),'-',int2str(hi),'.',int2str(0),int2str(ifig),'.eps'])
    else
        print('-depsc',['LZTWMG/WIGS/',IDENTIF,'-',int2str(lo),'-',int2str(hi),'.',int2str(ifig),'.eps'])
    end

end
%fid = fopen(['ARMMAP/MAPS/pks',IDENTIF,'_',int2str(lo),'-',int2str(hi),'-','ms',int2str(mshift),'-',int2str(winlen/40),'s'],'w');
fid = fopen(['LZTWMG/pks',IDENTIF,'_',int2str(lo),'-',int2str(hi),'-ms',int2str(mshift),'-',int2str(winlen/40),'s'],'w');
