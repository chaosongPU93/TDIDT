...
for k=1:ntees
    ...
    hold on
    if k==1
        axes('position',[0.05 0.8 0.2 0.2],'FontSize',6,'DataAspectRatio',[1 1 1],'XLim',[-4 4],'YLim',[-4 4])
    elseif k==2
        axes('position',[0.25 0.8 0.2 0.2],'FontSize',6,'DataAspectRatio',[1 1 1])
    elseif k==3
        axes('position',[0.45 0.8 0.2 0.2],'FontSize',6,'DataAspectRatio',[1 1 1])
    elseif k==4
        subplot('position',[0.05 0.55 0.2 0.2])
    elseif k==5
        subplot('position',[0.25 0.55 0.2 0.2])
    end    
    hold on
    if OLDER==0
        plot(0.33*youngerlocs(:,2),0.6*youngerlocs(:,3),'ro','MarkerSize',2,'linewidth',0.2)
    end
    hold on 
    plot(0.33*locs128(iend128:length(locs128),2),0.6*locs128(iend128:length(locs128),3),'ro','MarkerSize',2,'linewidth',0.2)
    ...
    scatter(0.33*locs128(istart128:iend128,2),0.6*locs128(istart128:iend128,3),90,locs128(istart128:iend128,1)...
        ,'linewidth',1)
    scatter(0.33*locs4(istart4:iend4,2),0.6*locs4(istart4:iend4,3),20,locs4(istart4:iend4,1),'filled')
    %axis equal
    %axis([-4 4 -4 4])
    %xlabel('PGSI - KM ESE')
    %ylabel('PGSS - KM NNE')
...
for k=1:ntees
    ...
    hold on
    if k==1
        subplot('position',[0.45 0.55 0.2 0.2])
    elseif k==2
        subplot('position',[0.05 0.3 0.2 0.2])
    elseif k==3
        subplot('position',[0.25 0.3 0.2 0.2])
    end    
    if OLDER==0
        plot(0.33*youngerlocs(:,2),0.6*youngerlocs(:,3),'ro','MarkerSize',2,'linewidth',0.2)
    end
...
for k=1:ntees
    ...
    hold on
    if k==1
        subplot('position',[0.45 0.3 0.2 0.2])
    elseif k==2
        subplot('position',[0.05 0.05 0.2 0.2])
    elseif k==3
        subplot('position',[0.25 0.05 0.2 0.2])
    end    
    if OLDER==0
        plot(0.33*youngerlocs(:,2),0.6*youngerlocs(:,3),'ro','MarkerSize',2,'linewidth',0.2)
    end
...
for k=1:ntees
    ...
    elseif k==2
        subplot('position',[0.25 0.05 0.2 0.2])
    elseif k==3
        subplot('position',[0.45 0.05 0.2 0.2])
    end    
    if OLDER==0
        plot(0.33*youngerlocs(:,2),0.6*youngerlocs(:,3),'ro','MarkerSize',2,'linewidth',0.2)
    end
