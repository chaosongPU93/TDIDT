...
timoffrot=[2005 254 07 42 12 +086 +020  80 115  55];  %Quite amazing migration
%%timoffrot=[2005 254 09 38 40 +085 +020  85 110  45]; %RESOLVED FRONTS spot.  3s window
timoffrot=[2005 254 09 38 40 +085 +020  80 115  55]; %RESOLVED FRONTS spot.  3s window
%timoffrot=[2005 254 07 41 40 +085 +020  80 115  55];  %Quite amazing migration
%timoffrot=[2005 255 01 32 12 +086 +021  80 105  50];
%timoffrot=[2005 255 01 31 00 +085 +020  80 115  55]; %fake
...
%timoffrot=[2004 197 10 32 20 +085 +020  80 115  55];
...
hold off;
plot(xcorr(realPGC/(std(realPGC)),realSILB/std(realSILB))/2^0.5)
onePGC = realPGC;
oneSSIB = realSILB;
onePGC(find(onePGC >0)) = 1;
onePGC(find(onePGC <0)) = -1;
oneSSIB(find(oneSSIB>0)) = 1;
oneSSIB(find(oneSSIB<0)) = -1;
hold on;
plot(xcorr(onePGC,oneSSIB),'r');hold off;

%plot(xcorr(realPGC,realSSIB))
stop
...
timbig=2*60; %was 4 or 4.33333333333334
winbig=2*timbig*40;
...
plot(timswin,0.5*scalef+zeros(nwin,1),'k:');
plot(timswin,ampSISS*scalef/ampmax,'k+','MarkerSize',2);
plot(timswin,ampPGSS*scalef/ampmax,'b+','MarkerSize',2);
plot(timswin,ampPGSI*scalef/ampmax,'r+','MarkerSize',2);
plot(timswin,xcmaxSISSn*scalef,'k');
plot(timswin,xcmaxPGSSn*scalef,'b');
plot(timswin,xcmaxPGSIn*scalef,'r');
...
axis([timlook-timbig timlook-timbig/2 -scalef scalef]);
xlabel('sec')
ylabel('samples')
box on
subplot(4,1,2); 
...
plot(timswin,xmaxPGSSn,'bs','MarkerSize',3);
plot(timswin,xmaxPGSIn,'ro','MarkerSize',3);
axis([timlook-timbig/2 timlook -scalef scalef]);
xlabel('sec')
ylabel('samples')
box on
subplot(4,1,3); 
...
plot(timswin,xmaxPGSSn,'bs','MarkerSize',3);
plot(timswin,xmaxPGSIn,'ro','MarkerSize',3);
axis([timlook timlook+timbig/2 -scalef scalef]);
xlabel('sec')
ylabel('samples')
box on
subplot(4,1,4); 
...
plot(timswin,zeros(nwin,1),'k:');
plot(timswin,0.5*scalef+zeros(nwin,1),'k:');
plot(timswin,ampPGSS*scalef/ampmax,'k+','MarkerSize',2);
plot(timswin,ampPGSS*scalef/ampmax,'b+','MarkerSize',2);
plot(timswin,ampPGSI*scalef/ampmax,'r+','MarkerSize',2);
plot(timswin,xcmaxSISSn*scalef,'k');
plot(timswin,xcmaxPGSSn*scalef,'b');
...
plot(timswin,xmaxPGSSn,'bs','MarkerSize',3);
plot(timswin,xmaxPGSIn,'ro','MarkerSize',3);
axis([timlook+timbig/2 timlook+timbig -scalef scalef]);
xlabel('sec')
ylabel('samples')
box on
...
plot(timsPGC,real(SSIBrot),'b');
plot(timsPGC,real(SILBrot),'k');
for n=1:length(locs4)
    plot([locs4(n,1)-2 locs4(n,1)+2],(0.75+0.05*mod(n,5))*[ltmax ltmax],'g');
end
