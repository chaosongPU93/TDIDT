...
for n=1:nwin;
    ...
    timswin(n)=timsPGC(mshift+istart); %+mshift???  Got rid of +winlen/2.
...
% templen=4*40;
% %starttempl=floor((timlook-timPGCfirst-30)*40); 
...
% timsPGCtx=timsPGC(2:tracelenPGC-templen+2); %Got rid of +templen/2
