...
if isequal(fam,'002')  %DON'T FORGET additional family-specific delcarations around line 156 
        ...
        datnames=['3STAS/STAS.exp.100sps.mjig15else0_N10e3.46';
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e4.06';
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e4.46';
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e4.76';
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e5.06';
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e5.46';
                  '3STAS/STAS.exp.100sps.mjig15else0_N10e6.06'];
                  %'3STAS/STAS.exp.100sps.mjig15else0_N10e6.46'];
%         datnames=['3STAS/STAS.exp.100sps.mjig0else0_N10e3.46';
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e3.96';
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e4.46';
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e4.96';
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e5.46';
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e5.96'];
%                   '3STAS/STAS.exp.100sps.mjig0else0_N10e6.46'];
%         datnames=['3STAS/STAS.uni.100sps.mjig15else0_N10e3.46';
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e3.96';
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e4.46';
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e4.96';
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e5.46';
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e5.96'];
%                   '3STAS/STAS.uni.100sps.mjig15else0_N10e6.46'];
%         datnames=['3STAS/STAS.uni.100sps.mjig0else0_N10e3.46';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e3.96';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e4.46';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e4.96';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e5.46';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e5.96';
%                   '3STAS/STAS.uni.100sps.mjig0else0_N10e6.46'];

%       datnames=['3STAS/STAS.uni.100sps.mjig7else1_N10e5';
%                 '3STAS/STAS.uni.100sps.mjig7else1_N10e6';
%                 '3STAS/STAS.uni.100sps.mjig7else1_N10e7'];
%       datnames=['3STAS/STAS.UN.100sps.mjig10else0_N10e4';
%                 '3STAS/STAS.UN.100sps.mjig10else0_N10e5';
%                 '3STAS/STAS.UN.100sps.mjig10else0_N10e6';
%                 '3STAS/STAS.UN.100sps.mjig10else0_N10e7'];
%       datnames=['3STAS/STAS.UN.100sps.mjig20else0_N10e4';
%                 '3STAS/STAS.UN.100sps.mjig20else0_N10e5';
%                 '3STAS/STAS.UN.100sps.mjig20else0_N10e6';
%                 '3STAS/STAS.UN.100sps.mjig20else0_N10e7'];
%       datnames=['3STAS/STAS.UN.100sps.mjig8else0.25_N10e4';
%                 '3STAS/STAS.UN.100sps.mjig8else0.25_N10e5';
%                 '3STAS/STAS.UN.100sps.mjig8else0.25_N10e6';
%                 '3STAS/STAS.UN.100sps.mjig8else0.25_N10e7'];
      %datnames='3STAS/STAS.DI.dt5.dmax2000.av3000.100sps.mjig0else0_N10e7.29';
      %datnames='3STAS/STAS.DI.dt5.dmax3000.av3000.100sps.mjig8else0_N10e7.4';
      %datnames='3STAS/STAS.DI.dt5.dmax3000.av3000.100sps.mjig5else0_N10e7.57'; %uncommented/compiled Jun 27  2019 wdwSYNTHstretch.m
%     datnames=['3STAS/STAS.LN.sig1.100sps.mjig5else0.6_N10e5';
%               '3STAS/STAS.LN.sig1.100sps.mjig5else0.6_N10e6';
%               '3STAS/STAS.LN.sig1.100sps.mjig5else0.6_N10e7'];
%     datnames=['3STAS/STAS.exp.100sps.mjig5else2_N10e4.33';
%               '3STAS/STAS.exp.100sps.mjig5else1_N10e4.33'];
%    datnames=['3STAS/STAS.uni.100sps.mjig5else1_N10e5';
%              '3STAS/STAS.uni.100sps.mjig5else1_N10e6';
%              '3STAS/STAS.uni.100sps.mjig5else1_N10e7';
%              '3STAS/STAS.uni.100sps.mjig5else1_N10e4'];
%     datnames=['3STAS/STAS.exp.100sps.mjig15else0_N10e5';
%               '3STAS/STAS.exp.100sps.mjig15else0_N10e6';
%               '3STAS/STAS.exp.100sps.mjig15else0_N10e7'];
%   datnames=['3STAS/STAS.uni.100sps.mjig0else1_N10e5.33';
%             '3STAS/STAS.uni.100sps.mjig0else1_N10e5.67';
%             '3STAS/STAS.uni.100sps.mjig0else1_N10e6.33';
%             '3STAS/STAS.uni.100sps.mjig0else1_N10e6.67';
%             '3STAS/STAS.uni.100sps.mjig0else1_N10e7.33';
%             '3STAS/STAS.uni.100sps.mjig0else1_N10e7.67'];
%    datnames=['3STAS/STAS.uni.100sps.mjig0_N10e5';
%              '3STAS/STAS.uni.100sps.mjig0_N10e6';
%              '3STAS/STAS.uni.100sps.mjig0_N10e7'];
%     datnames=['3STAS/STAS.uni.100sps.mjig7else1_N10e5.67';
%               '3STAS/STAS.uni.100sps.mjig7else1_N10e6.67';
%               '3STAS/STAS.uni.100sps.mjig7else1_N10e7.67'];
%     datnames=['3STAS/STAS.uni.100sps.mjig12_N10e5.3';
%               '3STAS/STAS.uni.100sps.mjig12_N10e6.3';
%               '3STAS/STAS.uni.100sps.mjig12_N10e7.3'];
    datsps=100;
    stas=['PGC '
          'SSIB'
          'SILB'];  
...
for ista=1:nsta
    if stas(ista,4) == ' '
        temptemps(ista,:)=load([stas(ista,1:3),'opt_',fam,'_',num2str(lo),'-',num2str(hi), ... %Read in the templates
                         'Hz_',int2str(npa),'pass_',int2str(sps),'sps.input'],'w');
%         getname=[stas(ista,1:3),'opt_',fam,'_',num2str(lo),'-',num2str(hi), ... 
%                          'Hz_',int2str(npa),'pass_',int2str(sps),'sps.input']
    else
...
for ista=1:nsta
    STAtemps(ista,:)=temptemps(ista,tempoffs(ista)-tempbef:tempoffs(ista)+tempaft); %Window the templates
...
% THIS IS A KLUDGE! Shopuld really read in b-band templates and bandpass
% them, not read in already-filtered templates (for scaling purposes)
    ttemp(1,:)=ttemp(1,:)*0.869;
    ttemp(2,:)=ttemp(2,:)*0.820;
    ttemp(3,:)=ttemp(3,:)*0.839;
% THIS IS A KLUDGE!
figure
hold on
for ista=1:nsta
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%Below is for comparison to STRETCHED template, + only
                        ...
                        for ista=1:nsta
                            for i=1:maxstretch-minstretch+1
                                dum=squeeze(STAstr(ista,i,:))'; %dummy version of the stretched template.  Why not "squeezed"?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%Above is for comparison to STRETCHED template, + only
    ...
    print('-dpdf','-painters',['3STAS23/FIGS/2023/',IDENTIF,'-',int2str(winlen/sps),'s_',num2str(lo),'-',num2str(hi),'b.pdf'])
    ...
    print('-dpdf','-painters',['3STAS23/FIGS/2023/',IDENTIF,'-',int2str(winlen/40),'s_',num2str(lo),'-',num2str(hi),'e.pdf'])
    ...
    for ifig=1:floor(nin/(nrow*mcol))+1
        g=figure('Position',[scrsz(3)/10 scrsz(4)/10 4*scrsz(3)/5 9*scrsz(4)/10]);
        fign(ifig)=gcf;
        if ifig > 5
            close(fign(ifig-5))
        end
...
% The above for running-sum dot product
        ...
        drawnow
        orient landscape
        set(g,'PaperPosition',[0.25 0.25 10.5 8])
%        if ifig <= 9
...
%        end
        if ifig <= 9
            ...
            print('-dpdf','-painters',['3STAS23/WIGS/2023/',IDENTIF,'-',num2str(lo),'-',num2str(hi),'ms',int2str(mshift),'-',int2str(winlen/sps),'s','.',int2str(0),int2str(0),int2str(ifig),'.pdf'])
%        elseif ifig <= 15 %99
