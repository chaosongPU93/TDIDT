...
%                     aSTA32keep(nin,:)=[timswin(n) aSTA32(n)];
    ...
    fid = fopen(['ARMMAP/MAPS/2018Aug/Bosmap',IDENTIF,'_',num2str(lo),'-',num2str(hi),'-','ms',int2str(mshift),'-',int2str(winlen/40),'s'],'w');
    fprintf(fid,'%9.1f %6.2f %6.2f %8.3f %7.2f %10.3e %10.3e %7.3f %7.3f %7.3f %10.3e %10.3e %7.3f %7.3f %7.3f %7.3f %7.3f %6.3f\n',mapfile(1:nin,:)');
    fclose(fid);
    fid = fopen(['ARMMAP/MAPS/2018Aug/Bosstr',IDENTIF,'_',num2str(lo),'-',num2str(hi),'-','ms',int2str(mshift),'-',int2str(winlen/40),'s'],'w');
