...
for n=1:nwin;
    if xcmaxAVEn(n)<0.35 || abs(xmaxPGSIn(n)-xmaxPGSSn(n)+xmaxSISSn(n))>2
    %if xcmaxAVEn(n)<0.33 || abs(xmaxPGSIn(n)-xmaxPGSSn(n)+xmaxSISSn(n))>2
    %if xcmaxAVEn(n)<0.3 || abs(xmaxPGSIn(n)-xmaxPGSSn(n)+xmaxSISSn(n))>2
    %if xcmaxAVEn(n)<medxcmaxAVEn || abs(xmaxPGSIn(n)-xmaxPGSSn(n)+xmaxSISSn(n))>2.5
