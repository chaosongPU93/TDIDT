...
%set(0,'DefaultFigureVisible','off');
    timoffrot(1,:)=[2005 213 07 42 12 +086 +020  80 115  50];
    timoffrot(2,:)=[2005 214 07 42 12 +086 +020  80 115  50];
    timoffrot(3,:)=[2005 215 07 42 12 +086 +020  80 115  50];
    timoffrot(4,:)=[2005 216 07 42 12 +086 +020  80 115  50];
    timoffrot(5,:)=[2005 217 07 42 12 +086 +020  80 115  50];
    timoffrot(6,:)=[2005 218 07 42 12 +086 +020  80 115  50];
    timoffrot(7,:)=[2005 219 07 42 12 +086 +020  80 115  50];
    timoffrot(8,:)=[2005 220 07 42 12 +086 +020  80 115  50];
    timoffrot(9,:)=[2005 221 07 42 12 +086 +020  80 115  50];
    timoffrot(10,:)=[2005 222 07 42 12 +086 +020  80 115  50];
    timoffrot(11,:)=[2005 223 07 42 12 +086 +020  80 115  50];
    timoffrot(12,:)=[2005 224 07 42 12 +086 +020  80 115  50];
    timoffrot(13,:)=[2005 225 07 42 12 +086 +020  80 115  50];
...
%     timoffrot(4,:)=[2005 260 07 42 12 +086 +020  80 115  50];
...
% %    
%     timoffrot(10,:)=[2003 062 07 42 12 +086 +020  80 115  50];
%     timoffrot(11,:)=[2003 063 07 42 12 +086 +020  80 115  50];
%     timoffrot(12,:)=[2003 064 07 42 12 +086 +020  80 115  50];
%     timoffrot(13,:)=[2003 068 07 42 12 +086 +020  80 115  50];
...
medhilPGC=median(hilPGC)
medhilSSIB=median(hilSSIB)
medhilSILB=median(hilSILB)
PGCoSSIB=medhilPGC/medhilSSIB
PGCoSILB=medhilPGC/medhilSILB

% hilPGC=hilPGC/medhilPGC;
% hilSSIB=hilSSIB/medhilSSIB;
% hilSILB=hilSILB/medhilSILB;
...
fid = fopen(['HILBERTS/PGC.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',PGCtrace(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SSIB.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',SSIBtrace(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SILB.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',SILBtrace(:,:)');
fclose(fid);

fid = fopen(['HILBERTS/PGCh.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%10.5e\n',hilPGC(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SSIBh.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%10.5e\n',hilSSIB(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SILBh.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%10.5e\n',hilSILB(:,:)');
fclose(fid);

fid = fopen(['HILBERTS/PGChp.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',PGCpeaks(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SSIBhp.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',SSIBpeaks(:,:)');
fclose(fid);
fid = fopen(['HILBERTS/SILBhp.',IDENTIF,'_',int2str(lo),'-',int2str(hi)],'w');
fprintf(fid,'%13.5f %9.5f\n',SILBpeaks(:,:)');
fclose(fid);
