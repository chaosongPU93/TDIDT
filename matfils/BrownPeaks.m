...
timoffrot=[254 09 38 40 +085 +020  80 115  55];
%***********************
jday=timoffrot(1);
JDAY=int2str(jday)
...
for n=1:ntemp;
    ...
    [speaks slocs]=findpeaks(PGCtn(:,n),'MINPEAKHEIGHT',0.1,'SORTSTR','descend');
    PGCpeaks(1:200,n)=speaks(1:200);
    PGClocs(1:200,n)=slocs(1:200);
    [speaks slocs]=findpeaks(SSIBtn(:,n),'MINPEAKHEIGHT',0.1,'SORTSTR','descend');
    SSIBpeaks(1:200,n)=speaks(1:200);
    SSIBlocs(1:200,n)=slocs(1:200);
    [speaks slocs]=findpeaks(SILBtn(:,n),'MINPEAKHEIGHT',0.1,'SORTSTR','descend');
    SILBpeaks(1:200,n)=speaks(1:200);
    SILBlocs(1:200,n)=slocs(1:200);
end
%lump things
find05'
out=zeros(f05,1); 
