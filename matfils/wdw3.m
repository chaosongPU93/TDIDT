...
%    timoffrot(1,:)=[2005 254 07 42 12 +086 +020  80 120  50];
     timoffrot(1,:)=[2005 255 07 42 12 +086 +020  80 120  50];
...
npo=2;
npa=1;
loopoffmax=4; %1.5 for standard 1.5-6Hz; 4 for 0.5-1.5Hz
xcmaxAVEnmin=0.4 %0.36 for 4s 1-12 Hz; %0.4 for 4s 1.5-6 Hz and 6s 0.5-1.5Hz; 0.36 for 4s2-8 Hz ; 0.38 for 4s0.75-6 Hz; 0.094 for 128s 2-8Hz;  0.1 for 128s 1.5-6Hz; 0.44 for 3-s window?
winlen=8*40; %4 for 1.5-6Hz; 8 for 0.5-1.5Hz
%winlen=128*40;
winoff=40*2; %*1;
%winoff=40*8;
year=timoffrot(nd,1);
