        ...
        for k=-mshift:mshift
            ...
            if k==0
                for inb=inbosstart:inbosend
                    plot(bostsec,0.85*ltmax,'ko','MarkerSize',3,'MarkerFaceColor','k')
                end
            end
...
% 3320.0    8.75    1.75  0.400  1.32     0.167     0.466  3320.400     0.477    -0.995     2.679
% 3340.0   -0.25    1.50  0.422  0.41     0.550     0.647  3338.675     0.545     1.133    -2.131
% .dx.inbox files; output from wiggledaywig3 etc. that falls w/in box.  Columns 2 and 3 are xmaxPGSIntmp, xmaxPGSSntmp.
