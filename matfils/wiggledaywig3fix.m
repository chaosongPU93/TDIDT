...
%         end
        ...
        %%%%%%%%%%%%%%%%
        istart=igstart+(n-1)*winoff+mshift; 
        iend=istart+winlen-1;
        winPGC=realPGC(istart:iend); winSSIB=realSSIB(istart:iend); winSILB=realSILB(istart:iend);
        xcPGSSn=xcorr(winSSIB,winPGC,mshift+10,'coeff');
        xcPGSIn=xcorr(winSILB,winPGC,mshift+10,'coeff');
        xcSISSn=xcorr(winSSIB,winSILB,mshift+10,'coeff');
