...
%    timoffrot(1,:)=[2005 257 07 42 12 +086 +033  80 120  45];

%    timoffrot(1,:)=[2005 255 07 42 12 +074 +024  90   5  40];
%    timoffrot(2,:)=[2005 256 07 42 12 +074 +024  90   5  40];
%    timoffrot(3,:)=[2005 257 07 42 12 +074 +024  90   5  40];
%    timoffrot(4,:)=[2005 258 07 42 12 +074 +024  90   5  40];

%    timoffrot(1,:)=[2005 255 07 42 12 +069 +039  80   5  45];
%    timoffrot(2,:)=[2005 256 07 42 12 +069 +039  80   5  45];
%    timoffrot(3,:)=[2005 257 07 42 12 +069 +039  80   5  45];
%    timoffrot(4,:)=[2005 258 07 42 12 +069 +039  80   5  45];
...
%    timoffrot(1,:)=[2005 254 07 42 12 +086 +013  80 115  50];
%    timoffrot(2,:)=[2005 255 07 42 12 +086 +013  80 115  50];
%    timoffrot(3,:)=[2005 256 07 42 12 +086 +013  80 115  50];
%    timoffrot(4,:)=[2005 257 07 42 12 +086 +013  80 115  50];

%    timoffrot(1,:)=[2005 254 07 42 12 +086 +027  80 120  45];
%    timoffrot(2,:)=[2005 255 07 42 12 +086 +027  80 120  45];
%    timoffrot(3,:)=[2005 256 07 42 12 +086 +027  80 120  45];
%    timoffrot(4,:)=[2005 257 07 42 12 +086 +027  80 120  45];
%    timoffrot(5,:)=[2005 258 07 42 12 +086 +027  80 120  45];
...
%    timoffrot(5,:)=[2004 195 07 42 12 +086 +013  80 115  50];
%    timoffrot(6,:)=[2004 196 07 42 12 +086 +013  80 115  50];
%    timoffrot(7,:)=[2004 197 07 42 12 +086 +013  80 115  50];
%    timoffrot(8,:)=[2004 198 07 42 12 +086 +013  80 115  50];

%    timoffrot(9,:)=[2004 196 07 42 12 +086 +027  80 120  45];
%    timoffrot(10,:)=[2004 197 07 42 12 +086 +027  80 120  45];
%    timoffrot(11,:)=[2004 198 07 42 12 +086 +027  80 120  45];
%    timoffrot(12,:)=[2004 199 07 42 12 +086 +027  80 120  45];
...
%   
%    timoffrot(5,:)=[2003 061 07 42 12 +086 +013  80 115  50];
%    timoffrot(6,:)=[2003 062 07 42 12 +086 +013  80 115  50];
%    timoffrot(7,:)=[2003 063 07 42 12 +086 +013  80 115  50];
%    timoffrot(8,:)=[2003 064 07 42 12 +086 +013  80 115  50];
% 
%    timoffrot(9,:)=[2003 062 07 42 12 +086 +027  80 120  45];
%    timoffrot(10,:)=[2003 063 07 42 12 +086 +027  80 120  45];
%    timoffrot(11,:)=[2003 064 07 42 12 +086 +027  80 120  45];
%    timoffrot(12,:)=[2003 065 07 42 12 +086 +027  80 120  45];
...
%    timoffrot(24,:)=[2004 363 05 19 48 +059 -073  85  65  55];   %FOR LOWER FREQUENCY  
   timoffrot(1,:)=[2004 364 05 19 48 +059 -073  85  65  55];   %FOR LOWER FREQUENCY  
...
%    timoffrot=[2005 258 07 42 12 +085 +042  75  85  45];
% 
...
mshift=15; %16 %11 %14 %12_for_+085+020
hi=6.;
lo=1.5;
% hi=8.;
% lo=2.;
...
[SSIBEf]=4.0e-3*bandpass(SSIBE,100,lo,hi,npo,npa,'butter'); %times 5 until Aug 2003 5.0*
[SSIBNf]=4.0e-3*bandpass(SSIBN,100,lo,hi,npo,npa,'butter'); %times 5 until Aug 2003 5.0*
[SILBEf]=4.0e-3*bandpass(SILBE,100,lo,hi,npo,npa,'butter'); %times 5 until Aug 2003 5.0* 
[SILBNf]=4.0e-3*bandpass(SILBN,100,lo,hi,npo,npa,'butter'); %times 5 until Aug 2003 5.0*
fltr=cputime-t
t=cputime;
...
for n=1:nwin
    if xcmaxAVEn(n)<xcmaxAVEnmin || abs(xmaxPGSIn(n)-xmaxPGSSn(n)+xmaxSISSn(n))>loopoffmax ...
            ...
            || nzerosPGC(n)>20 || nzerosSSIB(n)>20 || nzerosSILB(n)>20
