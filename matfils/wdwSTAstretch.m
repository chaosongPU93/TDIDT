...
%%%%%%%%%%%%%%%%%%%%%%%%%%%Below is for comparison to STRETCHED template, + only
    ...
    %                           [maxccdipole(ista,i),imaxdipole(ista,i)]=max(tempxc); %for each stretched template, the ccmax and its offset
                        ...
                        for ista=1:nsta 
                            ...
                            %%% ADDED by Chao, 2019/02/21, Problematic???
                            %%% with the function 'fminunc'
...
template_filtering_effect_PGC_enclosed_002_lf0_5_1_25_hf1_25_6_5_hfwin4_lfwin12_loff__ccmin__80sps