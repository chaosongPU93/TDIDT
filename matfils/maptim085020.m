...
OLDER=1;
% 
IDENTIF4b='map2003.063.85.20.80.115.55_2-8-4s';
IDENTIF128b='map2003.063.85.20.80.115.55_2-6-128s';
ALL128b='all.85.20.128s.fort.13.sor';
...
% OLDER=0;
% 
% IDENTIF4b='map2004.197.85.20.80.115.55_2-6-4s';
% IDENTIF128b='map2004.197.85.20.80.115.55_2-6-128s';
% ALL128b='all.85.20.128s.fort.13.sor';
...
% OLDER=1;
% 
% IDENTIF4b='map2004.199.85.20.80.115.55_2-6-4s';
% IDENTIF128b='map2004.197.85.20.80.115.55_2-6-128s';
% ALL128b='all.85.20.128s.fort.13.sor';
% OLDER128b='map2004.196.85.20.80.115.55_2-6-128s';
% OLDERb=1;
...
% OLDER=0;
% 
% IDENTIF4b='map2005.255.85.20.80.115.55_2-6-4s';
% IDENTIF128b='map2005.255.85.20.80.115.55_2-6-128s';
% ALL128b='all.85.20.128s.fort.13.sor';
...
% OLDER=1;
% 
% IDENTIF4b='map2005.257.85.20.80.115.55_2-6-4s';
% IDENTIF128b='map2005.256.85.20.80.115.55_2-6-128s';
% ALL128b='all.85.20.128s.fort.13.sor';
...
orient landscape
print(gcf,'-depsc',['maptime',IDENTIF4,'.eps'])
