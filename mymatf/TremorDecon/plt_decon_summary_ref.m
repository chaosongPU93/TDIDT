function [f] = plt_decon_summary_ref(sigsta,resgrp,pkindepsave,impindepst,sps,tmaxi,tmaxo,tbosti,...
  tbosto,ircccat,rcccat,irccrcat,rccrcat,off1iw,off1i,loff_max,tstbuf,tedbuf,dy,mo,yr,k,ftrans,xcut,ycut)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [f] = plt_decon_summary_ref(sigsta,resgrp,pkindepsave,impindepst,sps,tmaxi,tmaxo,...
