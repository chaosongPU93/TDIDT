...
for i = 1: nbst
  ...
  for j = 1: nwin
    ...
    [distnn1,dist2all,pca2vec(k,:),projang1(k,1),dprojxy1nn1,dprojxy12all,...
      projang2(k,1),dprojxy2nn1,dprojxy22all]=dist_evtcustom(impiwin,implociwin,sps,ftrans,'tarvl'); %tori
