...
text(ax,0.98,0.9,'Synthetic noise','Units','normalized','HorizontalAlignment','right','FontSize',10);
...
colormap(ax,newc);
caxis(ax,xzoom);
text(ax,0.98,0.9,'Synthetic noise zoom-in','Units','normalized','HorizontalAlignment','right','FontSize',10);
