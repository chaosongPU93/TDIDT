function f=plt_wholewin_summary_noise(sigsta,imp,timevec,locxy,imp4th,timevec4th,...
  locxy4th,tstbuf,dy,mo,yr,sps,ttype,purpose,saveflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% f=plt_wholewin_mapandproj4th_noise(torisplst,implocorist,lsig,...
%   sps,ttype,wt,torisplst4th,implocorist4th,wt4th)
%
% Similar to 'plt_wholewin_summary.m', this script would plot the detections
% BOTH after 2ndary removed AND after 4th-sta checked, but for noise.
...
% --Added the option of 'purpose', if specified as 'demo', then it can be called
% in should be called in 'deconv_4s_exp_4thsta_181demo.m'. 
%
%
...
if strcmp(purpose,'demo') && saveflag
  fname = strcat('wholewinsum_noi_demo.pdf');
  print(f.fig,'-dpdf',...
