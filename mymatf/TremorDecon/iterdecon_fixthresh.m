...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [sigdecon,pred,res,dresit,mfitit,ampit,nit,fighdl,rf] = ...
%   iterdecon_fixthresh(sig,wlet,rcc,noi,fixthresh,dt,twlet,width,dres_min,mfit_min,nit_max,nimp_max,fpltit,fpltend,fpltchk)
%
% Mutant of and almost identical to 'iterdecon.m', except that here uses
% a fixed threshold for the intermediate property 'medwtcoef', which is
% the product of rcc and wlet-res cc. This makes using the same threshold 
% as in the real data easy when you want to test with noise but stop at 
% the same threshold (which is now the input).
%
%
