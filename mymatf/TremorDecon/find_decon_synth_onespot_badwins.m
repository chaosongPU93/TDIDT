% find_decon_synth_onespot_badwins.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Similar to 'find_decon_synth_badwins.m', but deal with single-spot synthetics
%
...
if flagrecalc
  ...
  for iperc = 1: ntrial
    ...
    for insat = 1: nnsat
      ...
      %% save file      
      savefile = strcat('badwins_decon_synth_onespot','_noi',num2str(perc),'_nsat',...
