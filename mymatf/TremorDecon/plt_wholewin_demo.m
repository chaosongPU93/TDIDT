function f=plt_wholewin_demo(sigsta,imp,timevec,locxy,locxyproj,stats,...
  imp4th,timevec4th,locxy4th,locxyproj4th,stats4th,tstbuf,dy,mo,yr,sps,ttype,saveflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% f=plt_wholewin_demo(sigsta,imp,timevec,locxy,locxyproj,stats,...
...
% demonstration, should be called in 'deconv_4s_exp_4thsta_181demo.m'. 
%
%
% Chao Song, chaosong@princeton.edu
% First created date:   2024/04/12
...
if ~isempty(imp)
  ...
  % locxydum = sortrows([locxy timevec],-3);
...
if saveflag
  fname = strcat('wholewinsum_demo.pdf');
  print(f.fig,'-dpdf',...
