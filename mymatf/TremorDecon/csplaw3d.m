function [synths,mommax,sources,greensts]=csplaw3d(writes,winlen,skiplen,synth,Greens,b,...
...
for n0=1:length(writes)
  ...
  for n=1:sizernsor %writes(n0)
    ...
    % set(f2.fig,'Position',[10*scrsz(3)/20 scrsz(4)/10 widin*resol htin*resol]);
    % nrow = 1;
    % ncol = 1;
