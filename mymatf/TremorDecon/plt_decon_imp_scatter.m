function [ax,imptime,wt,xbnd,ybnd] = plt_decon_imp_scatter(ax,imp,xran,yran,cran,offxran,offyran,...
  sps,maxsybsz,fwt,ftime,fbnd)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [ax,imptime,wt,xbnd,ybnd] = plt_decon_imp_scatter(ax,imp,xran,yran,cran,offxran,offyran,...
%   sps,maxsybsz,fwt,ftime,fbnd)
%
