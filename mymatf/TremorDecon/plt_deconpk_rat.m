function plt_deconpk_rat(f,msrcampr,madsrcampr,nsrc,color,mpsrcamprs,madpsrcamprs,...
  mnsrcamprs,madnsrcamprs)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% plt_deconpk_rat(msrcampr,madsrcampr,nsrc,symbol,mpsrcamprs,madpsrcamprs,...
%   mnsrcamprs,madnsrcamprs)
%
