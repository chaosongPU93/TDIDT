% deconv_4s_exp_4thsta.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is the 'driver' script to call 'deconv_4s_exp_4thsta_fn' to do the
...
%   noiseflag = 0;
%   hibstsig = deconv_4s_exp_4thsta_fn(indenv123,normflag,noiseflag,pltflag,rccmwsec);
%   savefile = 'deconv1win_stats4th_hienvccbstsig.mat';
%   save(strcat(rstpath, '/MAPS/',savefile), 'hibstsig');
%   
%   %%%high-correlation bursts using synthetic noise
%   noiseflag = 1;
%   hibstnoi = deconv_4s_exp_4thsta_fn(indenv123,normflag,noiseflag,pltflag,rccmwsec);
%   savefile = 'deconv1win_stats4th_hienvccbstnoi.mat';
...
%   noiseflag = 0;
%   allbstsig = deconv_4s_exp_4thsta_fn(1:size(trange,1),normflag,noiseflag,pltflag,rccmwsec); %
%   savefile = 'deconv1win_stats4th_allbstsig0.25s.mat';
%   save(strcat(rstpath, '/MAPS/',savefile), 'allbstsig');
%   
%   %%%all bursts using synthetic noise
%   noiseflag = 1;
%   allbstnoi = deconv_4s_exp_4thsta_fn(1:size(trange,1),normflag,noiseflag,pltflag,rccmwsec);  %
%   savefile = 'deconv1win_stats4th_allbstnoi0.25s.mat';
%   save(strcat(rstpath, '/MAPS/',savefile), 'allbstnoi');
% else
%   savefile = 'deconv1win_stats4th_allbstsig0.25s.mat';
%   load(strcat(rstpath, '/MAPS/',savefile));
...
iplt = 0;
for i = 1: h.NumBins-1 
  ind = find(log10(ampdt)>=h.BinEdges(i) & log10(ampdt)<h.BinEdges(i+1));
...
iplt = 0;
for i = 1: h.NumBins-1 
  ind = find(log10(ampdtn)>=h.BinEdges(i) & log10(ampdtn)<h.BinEdges(i+1));
...
f=plt_srcdlocinmap(dt2all,dloc2all,imp,sps,'km');
...
propang = bstsig.propang;
proppear = bstsig.proppear;
pearmin = 0.5;
