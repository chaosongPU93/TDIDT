...
% redo analysis to following
ntran04redo = [
    2004195   4.1773e+04   4.3362e+04   % combine
    2004197   1.7973e+04   1.8738e+04
    2004197   1.8756e+04   2.0381e+04
    2004197   2.6469e+04   2.7180e+04
    2004197   2.9772e+04   3.0618e+04
    2004197   8.3402e+04   8.4888e+04
    2004197   8.5320e+04   8.6659e+04
    2004198   1.9151e+04   2.1616e+04
    2004198   4.2632e+04   4.3795e+04
    2004198   5.3506e+04   5.8050e+04
    2004198   6.2966e+04   6.3885e+04
    ...
    2004199   8.0861e+04   8.2008e+04
    2004199   8.2008e+04   8.3515e+04
    2004200   1.2600e+04   1.5799e+04
    2004200   1.5914e+04   1.7125e+04
    2004200   1.9104e+04   2.0110e+04   % check old param. to determine 
    2004200   4.8109e+04   4.8666e+04
    2004203   1.6586e+04   2.0776e+04   % combine them
    ];

% use the direction that max. speed instead of that min. rmse
ntran04speed = [
    ...
    2004198   3.2525e+04   3.5346e+04   % speed direct 285
    ...
    2004199   4.6340e+04   4.9126e+04   % combine, care speed direct, y
    ...
    2004199   8.0861e+04   8.2008e+04   % y, care speed direct
    2004199   8.2008e+04   8.3515e+04   % y, care speed direct
...
% ones need rechecking
ntran04retest = [
    2004199   8.2008e+04   8.3515e+04   % y, care speed direct, RECHECK PEAR    
    2004200   1.9104e+04   2.0110e+04   % check OLD param. to determine, y 
    ];
...
ntran05redo = [
    ...
    2005256   7.1496e+04   7.2720e+04
    2005256   7.2720e+04   7.3914e+04   
    2005256   7.6381e+04   7.7940e+04   % change end time
    2005257   6.1200e+03   7.7460e+03   % change start time
    2005257   9.0080e+03   1.2240e+04
    2005257   1.2240e+04   1.3853e+04
    ...
    2005258   3.5000e+04   3.6540e+04
    2005258   3.6540e+04   3.8160e+04
    2005258   3.8160e+04   4.0021e+04
    2005259   5.2320e+03   7.7140e+03   % check old param. to determine
    2005260   3.6040e+03   4.5000e+03
    2005260   4.6080e+03   6.6780e+03
...
ntran05speed = [
    ...
    2005256   4.6440e+04   4.8421e+04   % change start time, y, but check speed direc
    2005256   6.2640e+04   6.4865e+04   % change start time, y, but check speed direc
    2005256   7.1496e+04   7.2720e+04   % y, but check speed direc
    2005256   7.2720e+04   7.3914e+04   % y, but check speed direc
    2005256   8.4804e+04   8.5328e+04   % both direc bad, try 155
    2005257   6.1200e+03   7.7460e+03   % change start time, y, but check speed direc
    2005257   7.3440e+04   7.8840e+04   % change end time, y, but check speed direc
    2005257   8.2159e+04   8.3380e+04   % speed direct 350
    2005258   3.5000e+04   3.6540e+04   % y, but check speed direc
    2005258   3.8160e+04   4.0021e+04   % y, but check speed direc 
    2005259   1.5400e+02   1.6340e+03   % speed direct 75
    2005259   1.9560e+03   4.0460e+03   % speed direct 185
    2005259   5.2320e+03   7.7140e+03   % check old param. to determine, y, but check speed direc
    2005259   3.7000e+04   4.1293e+04   % speed direct 85
    2005260   2.6510e+03   3.4380e+03   % speed direct 80
    2005260   4.6080e+03   6.6780e+03   % y, but check speed direc
    2005260   9.4090e+03   1.0357e+04   % speed direct 55
    ];

% ones need rechecking
ntran05retest = [
    2005257   1.2240e+04   1.3248e+04   % CHANGED time, st-3.68
    2005258   3.5000e+04   3.6540e+04   % y, but check speed direc, RECHECK PEAR
    2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc, larger pear
    2005259   3.7000e+04   4.1293e+04   % speed direct 85, RECHECK PEAR
    ];

% ones need comparison with OLD times
ntrancomp = [
%     2004200   1.9104e+04   1.9900e+04   % check OLD param. to determine, y, use OLD end time
%     2004200   18500  19900  % old 19, rmse direc 255 
    2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc, larger pear
    2005259   5000   7700   % OLD 41, rmse direc 255
    ];

test = [
    2004197   7.7283e+04   7.9811e+04   % speed direct 270, y, but use rmse 195
    ];
...
angbest1 = angcandihf(:,1);
angbest2 = angcandihf(:,2);
...
% copy from uncommented in ntran04raw1
ntran04raw2 = [
    2004195   4.1773e+04   4.3362e+04   % combine
    2004196   6.9408e+04   7.1696e+04   % speed direct
    2004196   8.5935e+04   8.6386e+04   % speed direct
    ...
    2004197   7.9949e+04   8.1453e+04   % speed direct 260
    2004197   8.2312e+04   8.3103e+04   % speed direct 85
    2004197   8.3402e+04   8.4888e+04   % divided into 3, 1 discarded
    2004197   8.5320e+04   8.6659e+04   % divided into 3, 1 discarded
    2004198   5.9530e+03   9.7940e+03   % speed direct 270
    2004198   1.9151e+04   2.1616e+04   % acceptted
    2004198   3.2525e+04   3.3480e+04   % too complicated so modified time, but bad fitting due to spatial scatter
    2004198   4.2632e+04   4.3795e+04   % acceptted
...
% copy from ntran04raw2, redo analysis to following, discarded are commented out
ntran04redo = [
    2004195   4.1773e+04   4.3362e+04   % combine, y
%     2004197   1.7973e+04   1.8738e+04   % divided into 2, n, se
%     2004197   1.8756e+04   2.0381e+04   % divided into 2, n, pear
%     2004197   2.6469e+04   2.7180e+04   % modified time, n, se & pear
%     2004197   2.9772e+04   3.0618e+04   % modified time, n, se & pear
    2004197   8.3402e+04   8.4888e+04   % divided into 3, 1 discarded, y
    2004197   8.5320e+04   8.6659e+04   % divided into 3, 1 discarded, y
    2004198   1.9151e+04   2.1616e+04   % acceptted, y
%     2004198   3.2525e+04   3.3480e+04   % too complicated so modified time, but bad fitting due to spatial scatter
    ...
    2004198   8.4222e+04   8.7248e+04   % combine, y
%     2004199   4.6340e+04   4.9126e+04   % combine, care speed direct, y
%     2004199   8.0861e+04   8.2008e+04   % divided into 2, y, care speed direct
%     2004199   8.2008e+04   8.3515e+04   % divided into 2, y, care speed direct
    2004200   1.2600e+04   1.5799e+04   % modified time, y
    2004200   1.5914e+04   1.7125e+04   % acceptted, y
    2004200   1.9104e+04   2.0110e+04   % check OLD param. to determine, y 
    2004200   4.8109e+04   4.8666e+04   % acceptted, y
...
% copy from ntran04raw2, use the direction that max. speed instead of that min. rmse,
% discarded are commented out
ntran04speed = [
%     2004196   6.9408e+04   7.1696e+04   % speed direct, n
%     2004196   8.5935e+04   8.6386e+04   % speed direct, n
%     2004197   1.3192e+04   1.4362e+04   % speed direct, n
    2004197   4.0974e+04   4.2205e+04   % speed direct 90, y, larger pear
%     2004197   4.2322e+04   4.2941e+04   % speed direct 70, n, larger pear, too large se 
%     2004197   4.3031e+04   4.3632e+04   % speed direct 200, n
    2004197   5.4453e+04   5.5867e+04   % speed direct 205, y, but use rmse 220
    2004197   5.6270e+04   5.7227e+04   % speed direct 175, y, but use rmse 185
%     2004197   6.9950e+04   7.1112e+04   % speed direct 250, n, larger pear, too large se
%     2004197   7.1231e+04   7.3184e+04   % speed direct 305, n, larger pear, too large se 
%     2004197   7.7283e+04   7.9811e+04   % speed direct 270, n, bc 002 region, spatial scatter at 043, timely inseparatable 
    2004197   7.9949e+04   8.1453e+04   % speed direct 260, y, but use rmse 195
%     2004197   8.2312e+04   8.3103e+04   % speed direct 85, n
    2004198   5.9530e+03   9.7940e+03   % speed direct 270, y, but use rmse 235
%     2004198   3.2525e+04   3.3480e+04   % too complicated so modified time, but bad fitting due to spatial scatter
    2004199   4.1670e+03   6.2660e+03   % speed direct 280, y, larger pear
%     2004199   3.2442e+04   3.3827e+04   % speed direct 140, n
%     2004199   3.5985e+04   3.6346e+04   % speed direct 50, n
    2004199   4.2845e+04   4.3359e+04   % speed direct 270, y, but use rmse 250
    2004199   4.6340e+04   4.9126e+04   % combine, care speed direct, y, larger pear
    2004199   4.9744e+04   5.0614e+04   % speed direct 180, y, but use rmse 195
%     2004199   5.9508e+04   6.0735e+04   % speed direct 65, n
%     2004199   6.6269e+04   6.7368e+04   % speed direct 110, n
    2004199   8.0861e+04   8.2008e+04   % divided into 2, y, care speed direct, y, but use rmse 90
    2004199   8.2008e+04   8.3515e+04   % divided into 2, y, care speed direct, RECHECK PEAR
%     2004200   2.8316e+04   2.9468e+04   % speed direct 120, n
    2004201   4.3700e+02   1.6290e+03   % speed direct 225, y, but use rmse 260
%     2004203   6.4578e+04   6.5555e+04   % speed direct 250, n, larger pear, too large se 
%     2004203   6.6022e+04   6.6872e+04   % speed direct 235, n, larger pear, too large se
    ];

ntran04retest = [
    2004199   8.2008e+04   8.3515e+04   % y, care speed direct, RECHECK PEAR, slightly larger pear    
    2004200   1.9104e+04   2.0110e+04   % check OLD param. to determine, y, use OLD end time
    ];
...
% copy from uncommented in ntran05raw1
ntran05raw2 = [
    2005255   3.4400e+04   3.5612e+04   % speed direct 80
    2005255   4.6099e+04   4.6949e+04   % speed direct 65
    2005255   5.1129e+04   5.1945e+04   % speed direct 250
...
% copy from ntran05raw2, redo analysis to following, discarded are commented out
ntran05redo = [
    2005255   8.4296e+04   8.5634e+04   % combine them, y
    2005256   8.0330e+03   9.8280e+03   % y
    2005256   2.1492e+04   2.2294e+04   % change start time, y
    2005256   2.8080e+04   2.9172e+04   % change start time, y
    2005256   3.4776e+04   3.5238e+04   % change start time, y
    2005256   3.6900e+04   3.8520e+04   % change times, y
%     2005256   4.6440e+04   4.8421e+04   % change start time, y, check speed direc
    2005256   5.2020e+04   5.2596e+04   % change times, y
%     2005256   6.2640e+04   6.4865e+04   % change start time, y, check speed direc
%     2005256   7.1496e+04   7.2720e+04   % y, but check speed direc
%     2005256   7.2720e+04   7.3914e+04   % y, but check speed direc
    2005256   7.6381e+04   7.7940e+04   % change end time, y
%     2005257   6.1200e+03   7.7460e+03   % change start time, y, but check speed direc
%     2005257   9.0080e+03   1.2240e+04   % n, pear
%     2005257   1.2240e+04   1.3853e+04   % CHANGE time, st-3.68
    2005257   1.6920e+04   1.8655e+04   % change start time, y
    2005257   2.1070e+04   2.5365e+04   % y 
%     2005257   2.6280e+04   2.8055e+04   % change start time, n, pear=0.497
%     2005257   3.6000e+04   3.7598e+04   % change start time, n, no enough lf
    2005257   3.9000e+04   4.5418e+04   % change start time, y
    2005257   6.1449e+04   6.4012e+04   % y
%     2005257   7.3440e+04   7.8840e+04   % change end time, y, but check speed direc
%     2005258   2.6640e+04   2.8962e+04   % change start time, n, pear
%     2005258   3.5000e+04   3.6540e+04   % y, but check speed direc
    2005258   3.6540e+04   3.8160e+04   % y
%     2005258   3.8160e+04   4.0021e+04   % y, but check speed direc 
%     2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc
    2005260   3.6040e+03   4.5000e+03   % y
%     2005260   4.6080e+03   6.6780e+03   % y, but check speed direc
    2005260   5.6300e+04   5.8200e+04   % use old times, y
    ];
...
ntran05speed = [
    2005255   3.4400e+04   3.5612e+04   % speed direct 80, y, larger pear
%     2005255   4.6099e+04   4.6949e+04   % speed direct 65, n, larger pear, but too large se
%     2005255   5.1129e+04   5.1945e+04   % speed direct 250, n, larger pear, but too large se
%     2005255   5.8050e+04   5.9394e+04   % speed direct 95, n, smaller pear and too large se 
    2005255   6.0381e+04   6.1557e+04   % speed direct 150, y, but use rmse 110
    2005255   6.7268e+04   6.8535e+04   % speed direct 80, y, larger pear
%     2005255   7.5060e+04   7.5708e+04   % care speed direc, n, larger pear, but too large se
    2005256   3.6200e+03   4.9570e+03   % speed direct 265, y, larger pear
    2005256   1.3412e+04   1.4346e+04   % speed direct 65, y, but use rmse 80   
%     2005256   1.5237e+04   1.6010e+04   % speed direct 80, n, larger pear, but too large se
    2005256   1.9069e+04   2.0203e+04   % speed direct 195, y, larger pear
%     2005256   2.9715e+04   3.1203e+04   % speed direct 70, n, larger pear, but too large se
%     2005256   3.2636e+04   3.4444e+04   % speed direct 105, n, although larger pear and proper se
    2005256   4.6440e+04   4.8421e+04   % change start time, y, check speed direc, y, a bit awful
    2005256   6.2640e+04   6.4865e+04   % change start time, y, check speed direc, y, but use rmse 130
%     2005256   7.1496e+04   7.2720e+04   % y, but check speed direc, n
    2005256   7.2720e+04   7.3914e+04   % y, but check speed direc, y
%     2005256   8.4804e+04   8.5328e+04   % both direc bad, try 245, n
    2005257   6.1200e+03   7.7460e+03   % change start time, y, but check speed direc, y
    2005257   7.3440e+04   7.8840e+04   % change end time, y, but check speed direc, y, but use rmse 235
    2005257   8.2159e+04   8.3380e+04   % speed direct 350, y, larger pear
    2005258   3.5000e+04   3.6540e+04   % divided into 3,y, but check speed direc, RECHECK PEAR
    2005258   3.8160e+04   4.0021e+04   % divided into 3,y, but check speed direc y, slightly larger pear 
    2005259   1.5400e+02   1.6340e+03   % speed direct 75, y, larger pear
    2005259   1.9560e+03   4.0460e+03   % speed direct 185, y, but use rmse 140
    2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc, larger pear
%     2005259   3.7000e+04   4.1293e+04   % speed direct 85, RECHECK PEAR
    2005260   2.6510e+03   3.4380e+03   % speed direct 80, y, but use rmse 115
    2005260   4.6080e+03   6.6780e+03   % y, but check speed direc, y, larger pear
    2005260   9.4090e+03   1.0357e+04   % speed direct 55, y, but use rmse 115
    ];

ntran05retest = [
    2005257   1.2240e+04   1.3248e+04   % CHANGED time, st-3.68, y, use speed direc, larger pear, SUSPICOUS
    2005258   3.5000e+04   3.6540e+04   % y, but check speed direc, RECHECK PEAR, slightly larger pear, SUSPICOUS
    2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc, larger pear, use old direc 255
    2005259   3.7000e+04   4.1293e+04   % speed direct 85, RECHECK PEAR, y, but use rmse 115
    ];
...
ntran05acc = [
    ...
    2005258   3.5000e+04   3.6540e+04   % y, but check speed direc, RECHECK PEAR, slightly larger pear, SUSPICOUS
    2005258   3.6540e+04   3.8160e+04   % y
    2005258   3.8160e+04   4.0021e+04   % y, but check speed direc y, slightly larger pear 
    2005259   1.5400e+02   1.6340e+03   % speed direct 75, y, larger pear
    2005259   1.9560e+03   4.0460e+03   % speed direct 185, y, but use rmse 140
    2005259   5.2320e+03   7.7140e+03   % check OLD param. to determine, y, but check speed direc, larger pear, use old direc 255
    2005259   3.7000e+04   4.1293e+04   % speed direct 85, RECHECK PEAR, y, but use rmse 115
...
%%
tol = 1;
largediffind = find(abs(offdiff)>tol);
...
largediff = [    
    ...
    2005255   3.4400e+04   3.5612e+04   % speed direct 80, y, larger pear, 002 region
    2005256   8.0330e+03   9.8280e+03   % change end time, y, poor LF constraint?
    2005256   1.9069e+04   2.0203e+04   % speed direct 195, y, larger pear, poor LF constraint?
    ...
    2005259   1.5400e+02   1.6340e+03   % speed direct 75, y, larger pear, poor LF constraint?
    2005259   1.9560e+03   4.0460e+03   % speed direct 185, y, but use rmse 140, though it is not perfect in both passbands
