% function get_filtering_effect_LZBv2_freq
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%   80 sps base
%
%   from 'get_filtering_effect_LZBv2_addfam', this is to test the variation
%   of filtering effect with the frequency range used for bandpass. Previously,
%   the default range is lf: 0.5-1.25, hf: 1.25-6.5, this codes tries to use
%   different corners for hf.
%
%
% By Chao Song, chaosong@princeton.edu
% First created date:   2021/05/20
