...
[burst03, nburstlf03] = group_tremor_burst(hfinter03,lftime(il03,26),ttol,ntolhf,ntollf);
[burst04, nburstlf04] = group_tremor_burst(hfinter04,lftime(il04,26),ttol,ntolhf,ntollf);
[burst05, nburstlf05] = group_tremor_burst(hfinter05,lftime(il05,26),ttol,ntolhf,ntollf);
...
% for i = 41: 63
    ...
    if size(mighf,1)< ntolhf || size(miglf,1) < ntollf
