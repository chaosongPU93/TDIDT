function [dstack, ccstack] = mk_bbtemp_LZB2(fam,sps,templensec,ccmethod,plflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Why did I create version 2 here? 2022/03/30
%   This version looks almost identical to version 1 after checking, and version 1
%   allows the option to change the frequency range for CC in the 2nd step, so 
%   use 'mk_bbtemp_LZB.m' in the future!
% 
...
if plflag
    ...
    print(f.fig,'-depsc2',strcat(datapath, '/templates/PGCtrio/',fam,'.broadbandstack.eps'));
