...
%%% save figure
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_mainSW+NE_all','request','.pdf'));
...
%%% save figure
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_002SW+NE_all','request','.pdf'));
...
text(f.ax(5),0.03,0.3,strcat({'99% CI'}),'fontsize',11,'unit','normalized','horizontalalignment',...
 ...
 %%% save figure
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_mainSW+NE_2portions_all','request','.pdf'));
...
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_mainSW+NE_ind','request',...
      '.pdf'));
...
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_002SW+NE_ind','request',...
      '.pdf'));
...
text(f.ax(5),0.03,0.3,strcat({'99% CI'}),'fontsize',11,'unit','normalized','horizontalalignment',...
 ...
 %%% save figure
print(f.fig,'-dpdf',strcat(rstpath,'/vdist_unshifted_mainSW+NE_2portions_ind','request','.pdf'));
...
%%% save figure
print(f5.fig,'-dpdf',strcat(rstpath,'/LZB','request','.mig.lfit.sum.',num2str(winlenhf),'_',...
    num2str(winlenlf),'.',num2str(lofflf),'.',num2str(ccminlf),'.pdf'));
