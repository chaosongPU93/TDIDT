...
if dcutflag 
    hffname = strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.dcut.',SUFFIXhf);
    lffname = strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.dcut.',SUFFIXlf);
else
    hffname = strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.nodcut.',SUFFIXhf);
    lffname = strcat(rstpath, '/evtloc.all',num2str(nfam),'fam.nodcut.',SUFFIXlf);
end
...
for ista = 1: nstasnew
    ...
    if dcutflag
        fid = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                    'fam.dcut.',SUFFIXhf),'w+');
    else
        fid = fopen(strcat(rstpath, '/evtloc.',stasnew(ista,:),'check.all',num2str(nfam),...
                    'fam.nodcut.',SUFFIXhf),'w+');
    end
...
for ista = 4: nstasnew
    ...
    if dcutflag
        fid = fopen(strcat(rstpath, '/addstaoff.',stasnew(ista,:),'check.all',num2str(nfam),...
                    'fam.dcut.',SUFFIXhf),'w+');
    else
        fid = fopen(strcat(rstpath, '/addstaoff.',stasnew(ista,:),'check.all',num2str(nfam),...
                    'fam.nodcut.',SUFFIXhf),'w+');
    ...
    if dcutflag
        print(f1.fig,'-dpdf',strcat(rstpath,'/addstaoff.',stasnew(ista,:),'check.all',...
              num2str(nfam),'fam.dcut.',SUFFIXhf,'.pdf'));
    else
        print(f1.fig,'-dpdf',strcat(rstpath,'/addstaoff.',stasnew(ista,:),'check.all',...
              num2str(nfam),'fam.nodcut.',SUFFIXhf,'.pdf'));
    end
    ...
    title(ax,strcat(strtrim(stasnew(ista, :))));
    if dcutflag
        print(f2.fig,'-dpdf',strcat(rstpath,'/addstaoff.',stasnew(ista,:),'check.all',...
              num2str(nfam),'fam.dcut.',SUFFIXlf,'.pdf'));
    else
        print(f2.fig,'-dpdf',strcat(rstpath,'/addstaoff.',stasnew(ista,:),'check.all',...
              num2str(nfam),'fam.nodcut.',SUFFIXlf,'.pdf'));
    end
