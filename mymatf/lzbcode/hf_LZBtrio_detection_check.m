...
%
% Similar to hf_PGCtrio_detection_check_v2.m
%
% NOTES:
...
%%%%%%%%%%%%% START, USE THIS SECTION IF NO UPSAMPLING %%%%%%%%%%%%%%%%%%%%%%%            
...
%                         ccprior125(nin) ccprior(nin) ccpost125(nin) STAamp(nin,2) STAamp(nin,3) xcmaxSTA12n(n) xcmaxSTA13n(n) xcmaxSTA32n(n) ];
    ...
    fid = fopen(strcat(rstpath, '/MAPS/trace_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps'),'w+');
    ...
    fid = fopen(strcat(rstpath, '/MAPS/trace1day_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps'),'w+');
