% function mig_linear_fit_LZB_addfam_autortm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     hold(f.ax(6),'off');
    ...
    %%% save figure
    print(f.fig,'-dpdf',strcat(rstpath,'/LZB.',num2str(nfam),'autortm.mig.proj.lfit',...
...
%%% save figure
print(f123.fig,'-dpdf',strcat(rstpath,'/autortm.prop_direction_map',num2str(nfam),'.pdf'));
...
%%% save figure
print(f123.fig,'-dpdf',strcat(rstpath,'/autortm.prop_direction_4q_map',num2str(nfam),'.pdf'));
% print(f.fig,'-dpdf',strcat(rstpath,'/unnamed.',num2str(winlenhf),'_',...
%     num2str(winlenlf),'.',num2str(lofflf),'.',num2str(ccminlf),'.pdf'));
