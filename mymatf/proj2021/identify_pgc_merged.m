...
%
%
% this script reads in the merged detection file from all fams of interest,
% may or may not have distance cutoff, but definitely without duplicates from
% multiple fams. Then you can analyse them on a daily base.
%
%
% Note 2021/06/10:
...
%     fnamehf = strcat(hypopath, '/evtloc.pgcfam.pj21.',num2str(distmaxhf),'kmdcutnodou.',SUFFIXhf);
    fnamelf = strcat(hypopath, '/evtloc.pgcfam.pj21.',num2str(distmaxlf),'kmdcutnodou.',SUFFIXlf);
else
%     fnamehf = strcat(hypopath, '/evtloc.pgcfam.pj21.nodcutnodou.',SUFFIXhf);
    fnamelf = strcat(hypopath, '/evtloc.pgcfam.pj21.nodcutnodou.',SUFFIXlf);
end
...
%cycle over each day:
for nd=7: nday      % num of rows, also num of days
