...
%
% this is the version for merging fams using TWKB trio, the idea behind is the 
...
if dcutflag
    distmaxhf = 8;
    distmaxlf = 12;
    hffname = strcat(rstpath, '/evtloc.lzbfam.pj21.',num2str(distmaxhf),'kmdcut.',SUFFIXhf);
    lffname = strcat(rstpath, '/evtloc.lzbfam.pj21.',num2str(distmaxlf),'kmdcut.',SUFFIXlf);
else
    hffname = strcat(rstpath, '/evtloc.lzbfam.pj21.nodcut.',SUFFIXhf);
    lffname = strcat(rstpath, '/evtloc.lzbfam.pj21.nodcut.',SUFFIXlf);
end
...
if dcutflag 
    fidhf = fopen(strcat(rstpath, '/evtloc.lzbfam.pj21.',num2str(distmaxhf),'kmdcutnodou.',SUFFIXhf),'w+');
    fidlf = fopen(strcat(rstpath, '/evtloc.lzbfam.pj21.',num2str(distmaxlf),'kmdcutnodou.',SUFFIXlf),'w+');
else
    fidhf = fopen(strcat(rstpath, '/evtloc.lzbfam.pj21.nodcutnodou.',SUFFIXhf),'w+');
    fidlf = fopen(strcat(rstpath, '/evtloc.lzbfam.pj21.nodcutnodou.',SUFFIXlf),'w+');
end
