function [ircc,rcc12,rcc13,rcc23] = RunningCC3sta(trace,cclen)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[ircc,rcc12] = RunningCC(trace(:,1), trace(:,2), cclen);
[~,rcc13] = RunningCC(trace(:,1), trace(:,3), cclen);
[~,rcc23] = RunningCC(trace(:,2), trace(:,3), cclen);
