...
% filtcor = load(fname);
% spsratio = sps/40;
% filthf = -filtcor(:,1)*spsratio;   % hf template shift due to filterig effect, sign is the opposite
...
filtcor = load(fname);
spsratio = sps/80;
filthf = filtcor(:,1)*spsratio;   % hf template shift due to filterig effect, sign is the same 
...
[STA14meansec,STA14stdsec,STA134offsec,STA124offsec,STA134off,STA124off,STA14count,STA14tbg,STA14tct,STA14tdate,STA14cc] = ...
    Addcheck_meanstd(1,filthf,countmat14,offmat14,tbgmat14,tctmat14,tdatemat14,ccmat14,mshift,matrange,sps,stdtol,countmin);
...
[STA15meansec,STA15stdsec,STA135offsec,STA125offsec,STA135off,STA125off,STA15count,STA15tbg,STA15tct,STA15tdate,STA15cc] = ...
    Addcheck_meanstd(2,filthf,countmat15,offmat15,tbgmat15,tctmat15,tdatemat15,ccmat15,mshift,matrange,sps,stdtol,countmin);
...
[STA16meansec,STA16stdsec,STA136offsec,STA126offsec,STA136off,STA126off,STA16count,STA16tbg,STA16tct,STA16tdate,STA16cc] = ...
    Addcheck_meanstd(3,filthf,countmat16,offmat16,tbgmat16,tctmat16,tdatemat16,ccmat16,mshift,matrange,sps,stdtol,countmin);
...
[STA17meansec,STA17stdsec,STA137offsec,STA127offsec,STA137off,STA127off,STA17count,STA17tbg,STA17tct,STA17tdate,STA17cc] = ...
    Addcheck_meanstd(4,filthf,countmat17,offmat17,tbgmat17,tctmat17,tdatemat17,ccmat17,mshift,matrange,sps,stdtol,countmin);
...
print('-depsc',strcat(rstpath,'/FIGS/',PREFIX,'_','AddStaOffsetCheck', '_',num2str(lo),'-',num2str(hi),'_',strtrim(stasnew(1, :)),'&',strtrim(stasnew(2, :)),'&',strtrim(stasnew(3, :)),'_more.eps'));
