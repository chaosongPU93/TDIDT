...
% Using data at 40 sps, for fam 243,then add extra stations
% to check the validity of detections
%   
% This is a combination of hf_PGCtrio_detection_check_v3.m and
%    hf_LZBtrio_detection_check_v3.m
%
% NOTES:
...
loopoffmax=2; %1.5 for standard 1.5-6Hz; 4 for 0.5-1.5Hz.  2 for non-interpolated.   % what is loopoffmax, the circuit of time offsets
...
%     end
    ...
    %%% structure of allrst: 13+4*nstanew cols
