...
%                         ccprior125(nin) ccprior(nin) ccpost125(nin) STAamp(nin,2) STAamp(nin,3) xcmaxSTA12n(n) xcmaxSTA13n(n) xcmaxSTA32n(n) ];
                    ...
                    mapfile(nin,:)=[timswin(n) xmaxSTA13ntmp(n) xmaxSTA12ntmp(n) ...
                        ...
                        match(nin,1) match(nin,2) Prev(nin) Post(nin) Prev15(nin) Prev30(nin) ...
                        ccprior125(nin) ccprior(nin) ccpost125(nin) STAamp(nin,2) STAamp(nin,3) ...
                        sumsSTA12n(n,ceil(iSTA12bang/iup)) sumsSTA13n(n,ceil(iSTA13bang/iup)) ...
    ...
    fid = fopen([rstpath,'/MAPS/map_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps'],'w+');
    ...
    fid = fopen(strcat(rstpath, '/MAPS/seistrace_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps'),'w+');
    ...
    fid = fopen(strcat(rstpath, '/MAPS/seistraceoneday_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps'),'w+');
...
%         plot(icc3(istanew,:)-mshiftnew-1, cc3max(istanew,:), 'k+','Markersize',8);
    ...
    fid = fopen([rstpath,'/MAPS/mapaddcheck_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps', num2str(nstanew), 'newsta'],'w+');
    if nstanew == 3  
    ...
    fid = fopen(strcat(rstpath, '/MAPS/seistraceadd_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps', num2str(nstanew), 'newsta'),'w+');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% WAY 2 start %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%% Write results into files
    fid = fopen([rstpath,'/MAPS/mapallrst_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps',num2str(nstanew), 'newsta'],'w+');
    if nstanew == 3
    ...
    fid = fopen(strcat(rstpath, '/MAPS/seistraceall_up_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps',num2str(nstanew), 'newsta'),'w+');
    tracefile = [STA1file_new(1:nin_new*winlen,:) STA2file_new(1:nin_new*winlen,2) STA3file_new(1:nin_new*winlen,2) STAopt_new(:, 1:nin_new*winlen)'];
    if nstanew == 3
