% function get_filtering_effect_PGC
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This is the function to get the filtering effect under different frequency
% band for PGC trio
% Using the rotation parameters to read and rotate the data, we will
...
%
% Features:
%   1. Based on the all corrections by Yajun, assuming they are all right.
%   2. Obtain the templates using corrections at each station in one family
%   3. Apply different passbands
%   4. use the new BOSTOCK's LFE catalogs, different from that used in
%       detection!! But in detection, the catalog was not used anywhere.
%       However, it is possible that the rotation para, timoffrot are
%       consistent with the old catalog. The difference is compared with 
%       get_filtering_effect_PGCv2.m
%
%
