...
% Using data at 40 sps, but down-sampled to 20 sps, for fam 243,then add
% extra stations to check the validity of detections
%
% This is a combination of lf_PGCtrio_detection_check_v2.m and
%    lf_LZBtrio_detection_check_v2.m
%
% NOTES:
...
winlensec=16;     % offsec = 3 was used in first-year report
...
%         n=1;
        ...
        if xcmaxAVEn(n)<xcmaxAVEnmin || abs(loopoff(n))>loopoffmax ...
            ...
            if abs(iSTA12bang-imaxSTA12n) <= loopoffmax && ...  %not sure if these 3 lines are satisfied automatically ...
               ...
               3*xcmaxAVEnmin && abs(tmp12) <= mshift-cyclskip && ...  % xcmaxAVEnmin, predetermined
