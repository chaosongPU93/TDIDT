...
legend([p1,p2,p3,p4,p5,p6,p7,p8,p9],{'PGC-SSIB (12)','PGC-SILB (13)','SILB-SSIB (32)',...
...
% save fig
fignm = strcat(rstpath, '/FIGS/tempfeff_PGC_enc_',fam,'.hf',num2str(lohf),'-',num2str(hihf),...
...
legend(ax,[p1,p2,p3,p4,p5,p6,p7,p8,p9],{'PGC-SSIB (12)','PGC-SILB (13)','SILB-SSIB (32)',...
...
% save fig
fignm = strcat(rstpath, '/FIGS/tempfeff_PGC_enc_',fam,'.lf',num2str(lolf),'-',num2str(hilf),...
...
print(f.fig,'-depsc2',strcat('/home/data2/chaosong/CurrentResearch/Song_Rubin_2020/Figures/filtereffect.eps'));
print(f.fig,'-dpdf',strcat('/home/data2/chaosong/CurrentResearch/Song_Rubin_2020/Figures/filtereffect.pdf'));
%%%% end for lf
...
% fid = fopen(strcat(rstpath, '/MAPS/tempfeff_PGC_enc','_',PREFIX),'w+'); % template filtering effect for PGC trio enclosed
% fprintf(fid,'%d %d %d \n',savemat');
% fclose(fid);
% 
...
%                 '.hw',num2str(wlensechf),'.lw',num2str(wlenseclf),'.lo',num2str(loopoffmax),'.ccm', ...
%                 num2str(xcmaxAVEnmin),'.',num2str(sps),'sps');
% fid = fopen(strcat(rstpath, '/MAPS/ccwidth_PGC','_',PREFIX),'w+'); % cc width estimate
% fprintf(fid,'%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f \n',dec');
% fclose(fid);


% %% plot a summary plot for paper
