...
%         plot(icc3(istanew,:)-mshiftnew-1, cc3max(istanew,:), 'k+','Markersize',8);
    ...
    fid = fopen([workpath,'/PGCtrio/MAPS/mapallrst',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps', num2str(nstanew), 'newsta'],'w+');
    ...
    fid = fopen(strcat(workpath, '/PGCtrio/MAPS/seistraceall_',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s',num2str(sps),'sps', num2str(nstanew), 'newsta'),'w+');
    ...
    for ifig=1:floor(nin_new/(nrow*mcol))+1
        ...
        orient landscape
        if ifig <= 9
            print('-depsc',[workpath,'/PGCtrio/WIGS/',IDENTIF,'_','AddStaComp','_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(0),int2str(0),int2str(ifig),'.eps'])
        elseif ifig <= 99
            print('-depsc',[workpath,'/PGCtrio/WIGS/',IDENTIF,'_','AddStaComp','_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(0),int2str(ifig),'.eps'])
        else
            print('-depsc',[workpath,'/PGCtrio/WIGS/',IDENTIF,'_','AddStaComp','_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(ifig),'.eps'])
        end
