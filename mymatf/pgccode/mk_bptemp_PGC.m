function [dstack, ccstack] = mk_bptemp_PGC(fam,sps,bplo,bphi,ccmethod,plflag)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%                 [opt,ort,~,timeperm]=readpermsv2(prename,PERMSTA,PERMROTS,idx,sps,bplo,bphi,...
%                                                  2,2,fact,1,40,0,20);   % just give some reasonable values
        ...
        if LIA
            ...
            if isfile(fname)    % if have the data file
                ...
                % 2. this is for data with no response
%                 [opt,ort,~]=readpolsv2(prename,POLSTA,POLROTS,idx,sps,bplo,bphi,2,2,fact,1,40,0,...
%                                        20);    % just give some reasonable values 
