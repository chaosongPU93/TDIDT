...
%
% Based on lf_PGCtrio_detection_resample.m & wdwSTAadd.m
%   1. Delete the broader band part
%   2. Delete other unused and commented lines
%   3. Modify several lines to save memory
%
% Modified by Chao Song, chaosong@princeton.edu
% First created date:   2019/03/17
...
winlensec=12;     % cc window length in sec
...
%     %%% AND, xcmaxAVEnbang is more reasonable to save 
    ...
    title([IDENTIF,'_{',num2str(lo),'-',num2str(hi),'}'])
    print('-depsc',[workpath,'/PGCtrio/FIGS/',IDENTIF,'-',num2str(winlen/sps),'s_',num2str(sps),'sps_',num2str(lo),'-',num2str(hi),'e.eps'])
    close(102)
