...
%%%%%%%%%% comment if you do not want save file
...
%     writeouts=0; %how many traces to write out?
    ...
    for ifig=1:floor(nin/(nrow*mcol))+1
        f=figure('Position',[scrsz(3)/10 scrsz(4)/10 4*scrsz(3)/5 9*scrsz(4)/10]);
        f.Renderer = 'painters';
        fign(ifig)=gcf;
        if ifig > 5
            close(fign(ifig-5))
...
%                     end
                     ...
                     %% plot subfigures at 1st row (0*3+1), 4th row (1*3+1),...,(n-1)*3+1 row
...
%                      text(is+STA32file(nt,3)/sps, -0.75*yma, num2str(match(nt,2),2),'fontsize',6,'color','r');
                     ...
                     %% plot subfigures at 2nd row (0*3+2), 5th row (1*3+2),..., (n-1)*3+2 row
...
%                      plot(xvect,yvect,'r','linewidth',3)
                     ...
                     %% plot subfigures at 3rd row (0*3+3), 6th row (1*3+3),..., (n-1)*3+3 row
                     ...
                     cclen=22; %running cc window length, in samples, 0.5s
                     ...
                     plot(STA1file(winlen*(nt-1)+round(cclen/2)+1:winlen*nt-round(cclen/2),1),(yma+ymi)/2+(yma-ymi)*alln/2,'co','markersize',1)
                     hold on
...
%             print('-depsc',['ARMMAP/WIGS/2018Sep/',IDENTIF,'-',num2str(lo),'-',num2str(hi),'ms',int2str(mshift),'-',int2str(winlen/sps),'s','.',int2str(0),int2str(0),int2str(ifig),'.eps'])
            print('-depsc', [rstpath,'/WIGS/',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(0),int2str(0),int2str(ifig),'.eps'])
        elseif ifig <= 99
%             print('-depsc',['ARMMAP/WIGS/2018Sep/',IDENTIF,'-',num2str(lo),'-',num2str(hi),'ms',int2str(mshift),'-',int2str(winlen/sps),'s','.',int2str(0),int2str(ifig),'.eps'])
            print('-depsc', [rstpath,'/WIGS/',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(0),int2str(ifig),'.eps'])
        else
%             print('-depsc',['ARMMAP/WIGS/2018Sep/',IDENTIF,'-',num2str(lo),'-',num2str(hi),'ms',int2str(mshift),'-',int2str(winlen/sps),'s','.',int2str(ifig),'.eps'])
            print('-depsc', [rstpath,'/WIGS/',IDENTIF,'_',num2str(lo),'-',num2str(hi),'_',num2str(winlen/sps),'s_',num2str(sps),'sps','.',int2str(ifig),'.eps'])
        end
