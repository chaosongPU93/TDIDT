...
%
%
% Note that matlab has a built-in called 'highpass' with 
% lower-case letters, to distinguish them, this version
% starts with the upper-case 'H'

% Last modified by fjsimons-at-alum.mit.edu, 09/19/2007
% Slightly changed by chaosong@princeton.edu, 12/21/2021
