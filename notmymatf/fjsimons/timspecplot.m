...
%
% Last modified by jdsimon-at-princeton.edu Apr. 29, 2015 to use
% SPECTROGRAM2 (FJS function) and not SPECTROGRAM (Matlab builtin)
...
[Ba2,F,T,Bl10]=spectrogram2(x,nfft,Fs,wlen,ceil(wolap*wlen),unt);
