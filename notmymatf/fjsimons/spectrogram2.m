function [Ba2,F,T,Bl10]=spectrogram2(x,nfft,Fs,wlen,olap,unt)
% [Ba2,F,T,Bl10]=SPECTROGRAM2(x,nfft,Fs,wlen,olap,unt)
% 
% JOEL -- use SPECTROGRAM2; spectrogram is a builtin.  Calculates,
% but does not plot, spectrogram.
%
...
% Last modified by jdsimon-at-princeton.edu Apr. 21, 2015
...
if nfft>wlen
  fprintf('SPECTROGRAM: NFFT of %i is larger than window length of %i\n',...
	       nfft,wlen)
end
if nfft<wlen
...
fprintf('Window size for SPECTROGRAM:    %g %s\n',wlen/Fs,unt)
