...
% Provide output
%%%added by CHao, 20220616
%If there is only 1 window, there is no robust estimate, return the non-robust estimate 
if nwin == 1
  SD = Snon;  % to avoid using diff. output format when nwin==1, otherwise it is NaN
end
%%%added by CHao, 20220616
